        ...
        const linkPayload = [
            {
                ...
                value: tx_1.LinkRequest.fromPartial({
                    sender: (0, utils_1.toAccAddress)(address),
            ...
            const confirmDepositPayload = [
                {
                    ...
                    value: tx_1.ConfirmDepositRequest.fromPartial({
                        sender: (0, utils_1.toAccAddress)(address),
                        depositAddress: (0, utils_1.toAccAddress)(_depositAddress),
                        denom,
                    }),
                },
            ];
            ...
            const confirmDepositPayload = [
                {
                    ...
                    value: tx_2.ConfirmDepositRequest.fromPartial({
                        sender: (0, utils_1.toAccAddress)(address),
                        chain,
                        txId: ethers_1.utils.arrayify(txHash),
                        burnerAddress: ethers_1.utils.arrayify(burnerAddress),
                    }),
                },
            ];
            const memo = `Generated from Javascript for ${address}!`;
