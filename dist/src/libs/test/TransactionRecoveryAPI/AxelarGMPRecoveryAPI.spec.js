...
describe("AxelarGMPRecoveryAPI", () => {
    ...
    describe("addGasToXrplChain", () => {
        const api = new AxelarGMPRecoveryAPI_1.AxelarGMPRecoveryAPI({ environment: types_1.Environment.TESTNET });
        it("should return transaction data for adding gas to xrpl chain", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield api.addGasToXrplChain({
                senderAddress,
                messageId,
                amount,
                tokenSymbol,
    ...
    describe("addGasToStellarChain", () => {
        ...
        function fundAccountIfNeeded(address) {
            return __awaiter(this, void 0, void 0, function* () {
                const server = new stellar_sdk_1.Horizon.Server("https://soroban-testnet.stellar.org");
                try {
                    yield server.accounts().accountId(address).call();
                }
                catch (e) {
                    yield fetch(`https://friendbot.stellar.org?addr=${encodeURIComponent(address)}`);
                }
            });
        }
        it("should return transaction data for adding gas to stellar chain", () => __awaiter(void 0, void 0, void 0, function* () {
            yield fundAccountIfNeeded(randomAddress);
            const response = yield api.addGasToStellarChain({
