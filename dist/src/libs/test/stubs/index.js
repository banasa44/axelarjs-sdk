...
exports.getFeeStub = exports.transferResponseExecutedStub = exports.batchedCommandResponseStub = exports.axelarTxResponseStub = exports.chainInfoStub = exports.evmEventStubResponse = exports.contractReceiptStub = exports.executeParamsStub = exports.newRoomIdStub = exports.linkEventStub = exports.depositAddressPayloadStub = exports.roomIdStub = exports.apiErrorStub = exports.findEventAndConfirmStub = exports.batchCommandStub = exports.otcStub = exports.activeChainsStub = exports.terraAddressStub = exports.ethAddressStub = exports.uuidStub = void 0;
...
exports.activeChainsStub = activeChainsStub;
const otcStub = () => ({
    otc: "hr64_XnjNE",
...
exports.batchCommandStub = batchCommandStub;
const findEventAndConfirmStub = () => ({
    success: true,
    errorMessage: undefined,
    infoLogs: ["Log 1", "Log 2", "Log 3"],
    commandId: "commandId",
    confirmTx: (0, exports.axelarTxResponseStub)(),
    eventResponse: (0, exports.evmEventStubResponse)().eventResponse,
});
exports.findEventAndConfirmStub = findEventAndConfirmStub;
const apiErrorStub = () => ({
...
const executeParamsStub = () => ({
    ...
    sourceChain: EvmChain_1.EvmChain.FANTOM,
    srcTxInfo: {
        transactionHash: "0x",
        transactionIndex: 0,
        logIndex: 0,
...
const evmEventStubResponse = () => ({
    ...
    eventResponse: {
        event: {
            chain: "Moonbeam",
            txId: new Uint8Array(),
            index: long_1.default.fromNumber(1),
            status: 2,
            tokenSent: undefined,
...
exports.evmEventStubResponse = evmEventStubResponse;
const chainInfoStub = () => ({
    id: "mockedId",
    assets: [],
    rpc: [],
...
exports.chainInfoStub = chainInfoStub;
...
const transferResponseExecutedStub = () => {
    return [
        {
            source: {
...
exports.transferResponseExecutedStub = transferResponseExecutedStub;
const getFeeStub = () => ({
    method: "getFees",
    params: {
        method: "getFees",
