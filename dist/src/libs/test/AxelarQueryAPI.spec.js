...
describe("AxelarQueryAPI", () => {
    ...
    describe("estimateGasFee", () => {
        ...
        test.skip("it should be able to return the gas fee when the destination chain is L2, but the executeData is undefined ", () => __awaiter(void 0, void 0, void 0, function* () {
            const l2Chains = ["fraxtal", "blast-sepolia", "mantle-sepolia"];
            const queries = [];
            for (const l2Chain of l2Chains) {
                const estimateGasFeeQuery = yield api.estimateGasFee("ethereum-sepolia", l2Chain, 500000, undefined, undefined, undefined, "0x");
                queries.push(estimateGasFeeQuery);
            }
            const responses = yield Promise.all(queries);
            for (const response of responses) {
